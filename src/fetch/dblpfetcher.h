...
#ifndef TELLICO_DBLPFETCHER_H
#define TELLICO_DBLPFETCHER_H
...
/**
 * A fetcher for dblp.org
 *
 * @author Robby Stephenson
 */
class DBLPFetcher : public XMLFetcher {
Q_OBJECT

public:
  /**
   */
  DBLPFetcher(QObject* parent);
  /**
   */
  virtual ~DBLPFetcher();
  ...
  virtual Type type() const Q_DECL_OVERRIDE { return DBLP; }
  ...
  public:
    explicit ConfigWidget(QWidget* parent_, const DBLPFetcher* fetcher = nullptr);
