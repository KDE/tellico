...
# ***************************************************************************
# Copyright			 : (C) 2008-2009 by Raphaël Fischer
# email		 : fischer.tellico@free.fr
# ***************************************************************************
# You are welcome to report any bug to Raphaël Fischer, such as missing or wrong information,
# when comparing to linked bedetheque.com page.
#
# ***************************************************************************
# *                                                                         *
...
class BasicTellicoDOM:
	...
	def __init__(self):
		...
		self.newField(field = {'flags' : '7', 'title' : 'Colorist', 'category' : 'General', 'format': '2', 'type': '1', 'name': 'colorist', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'ISBN', 'category' : 'Publication', 'format' : '4', 'type' : '1', 'name' : 'isbn', 'description' : 'ISBN#', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Estimation', 'category' : 'Classification', 'format' : '4', 'type' : '1', 'name' : 'estimation', 'description' : 'Cote de l\'exemplaire', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Dépot légal', 'category' : 'Publication', 'format' : '4', 'type' : '1', 'name' : 'depotlegal', 'description' : 'Dépot légal', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Achevé d\'imprimer', 'category' : 'Publication', 'format' : '4', 'type' : '1', 'name' : 'acheveimprimer', 'description' : 'Date d\'impression', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Quatrième de couverture', 'format' : '4', 'type' : '10', 'name' : 'back', 'description' : 'Quatrième de couverture', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Planche', 'category' : 'Planche', 'format' : '4', 'type' : '10', 'name' : 'planche', 'description' : 'Planche', 'i18n': 'true'})
		self.newField(field = {'flags' : '2', 'title' : 'Intégrale', 'category' : 'Classification', 'format' : '4', 'type' : '4', 'name' : 'class-int', 'i18n': 'true'})
		self.newField(field = {'flags' : '2', 'title' : 'Édition Originale', 'category' : 'Classification', 'format' : '4', 'type' : '4', 'name' : 'class-eo', 'i18n': 'true'})
		self.newField(field = {'flags' : '2', 'title' : 'Tirage de Tête', 'category' : 'Classification', 'format' : '4', 'type' : '4', 'name' : 'class-tt', 'i18n': 'true'})
		self.newField(field = {'flags' : '2', 'title' : 'Broché', 'category' : 'Classification', 'format' : '4', 'type' : '4', 'name' : 'class-br', 'i18n': 'true'})
		self.newField(field = {'flags' : '2', 'title' : 'Tirage Limité', 'category' : 'Classification', 'format' : '4', 'type' : '4', 'name' : 'class-tl', 'i18n': 'true'})
		self.newField(field = {'flags' : '0', 'title' : 'Bedetheque Link', 'category' : 'Classification', 'format' : '4', 'type' : '7', 'name' : 'bedetheque', 'i18n': 'true'})
		field = {'name': 'note', 'title': 'Note', 'flags': '0', 'category': 'Personnel', 'format': '4', 'type': '14', 'description': 'Avis sur l\'album', 'i18n': 'true'}
...
class BDthequeParser:
	...
	def __init__(self):
		...
		self.__regExps = {
						...
						'note' : '<p class="static">Note: <strong> ([0-9]+)\.([0-9]?)</strong>/10 \([0-9]+ votes?\)<br>Vous devez être connecté pour voter</p>',
		...
		self.__serieRE = {
						...
						'item' 						: '<td align="left" valign="top" WIDTH="[0-9]*"><div class="img-shadow">.*?Vous devez vous <A HREF="index.php"><u>identifier</u></a> pour saisir un commentaire, une correction ou voter pour cet album.<br></font>',
		...
		for albumid in linksorder:
			...
			if self.__fast > 0 and len(links) > self.__fast:
				...
				for dl, issue in issues:
					...
					data['texte_chronique'] = "<b>Message du script</b> : En raison du grand nombre de résultats, seule la recherche rapide a été effectuée. Sélectionnez les albums qui vous interessent puis lancez la mise-à-jour sur ceux-ci pour obtenir les renseignement complets.<br>Si vous ne souhaitez modifier ce comportement, ajoutez '-f nbr' à votre recherche ou à la configuration du script, où nbr est la limite d'albums à rechercher. (0 pour désactiver cette fonction)<br>Pour ne plus voir apparaitre ce message lors des recherches rapides, commentez la ligne 737 du script."
					if n:
