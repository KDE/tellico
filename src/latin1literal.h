...
bool operator==(const QString&, const Bookcase::Latin1LiteralInternal&);
 ...
 * \endcode
 *
 * @version $Id: latin1literal.h 770 2004-08-19 06:00:17Z robby $
 */
#define Latin1Literal(s) \
    Bookcase::Latin1LiteralInternal((s), sizeof(s)/sizeof(char)-1)

class Latin1LiteralInternal {
friend bool ::operator==(const QString&, const Latin1LiteralInternal&);
...
inline bool operator==(const QString& s1, const Bookcase::Latin1LiteralInternal& s2) {
...
inline bool operator==(const Bookcase::Latin1LiteralInternal& s1, const QString& s2) {
  return s2 == s1;
}
