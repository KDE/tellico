...
StringMapDialog::StringMapDialog(const QMap<QString, QString>& map_, QWidget* parent_, bool modal_/*=false*/)
  ...
  bb->addButton(KGuiItem(i18nn("set a value", "&Set") ,KIcon(QLatin1String("document-new"))),
                QDialogButtonBox::ActionRole,
                this, SLOT(slotAdd()));
  bb->addButton(KGuiItem(i18n("delete a value", "&Delete"), KIcon(QLatin1String("edit-delete"))),
                QDialogButtonBox::ActionRole,
