...
<!--
   ===================================================================
   Bookcase XSLT file - used for importing Amazon Web Services data.

   $Id: amazon2bookcase.xsl 753 2004-08-09 02:38:10Z robby $
 ...
 <bookcase syntaxVersion="6">
  <collection title="Amazon Import">
   ...
   <fields>
    ...
    <!-- the amazon importer will actually download these images and ignore these fields -->
